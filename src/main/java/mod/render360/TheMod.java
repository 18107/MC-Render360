...
@Mod(modid = TheMod.MOD_ID, name = TheMod.MOD_NAME, version = TheMod.MOD_VERSION, useMetadata = true, acceptableRemoteVersions = "*", dependencies = "required-after:render360core@1.0.1")
public class TheMod
{
