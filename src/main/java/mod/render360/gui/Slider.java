...
public class Slider extends GuiButton
{
    ...
    private Slider.FormatHelper formatHelper;
    ...
    {
        return this.formatHelper == null ? I18n.format(this.name, new Object[0]) + ": " + new DecimalFormat("#.#").format(this.getSliderValue()) : this.formatHelper.getText(this.id, I18n.format(this.name, new Object[0]), this.getSliderValue());
    }
